...
declare const globalThis: {
  __storageInstance?: IStorage;
};

export function getStorage(): IStorage {
  if (!globalThis.__storageInstance) {
    const db = getDb();
    globalThis.__storageInstance = db ? new DatabaseStorage() : new InMemoryStorage();
  }
  return globalThis.__storageInstance;
}
